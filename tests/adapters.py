...
from cs336_basics.layers import (
    ...
    RotaryPositionalEmbedding, MHA, TransformerBlock, TransformerLM,
    softmax, scaled_dot_product_attention,
)

from cs336_basics.training import (
    cross_entropy, AdamW, learning_rate_schedule, 
...
def run_scaled_dot_product_attention(
    ...
    """
    return scaled_dot_product_attention(key=K, query=Q, value=V, mask=mask)
...
def run_transformer_lm(
    ...
    """
    transformerlm = TransformerLM(d_model, num_heads, d_ff, vocab_size, num_layers, rope_theta, context_length)
